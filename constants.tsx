...
export const CONFIG_LOJA: ShopConfig = {
  name: "Barbearia do Ico",
  description: "Tradição e estilo em São Gonçalo. A Barbearia do Ico une o melhor da barbearia clássica com as técnicas mais modernas. O seu lugar de confiança para um corte impecável.",
  aboutTitle: "Nossa História Signature",
  aboutText: "O Ico começou com uma tesoura e um sonho. Hoje, a Barbearia do Ico é referência em São Gonçalo, unindo tradição, qualidade e o atendimento personalizado que fez nossa clientela crescer.",
  address: "Av. Amaral Peixoto, s/n",
  city: "São Gonçalo",
  state: "RJ",
  whatsapp: "5521974701455",
  instagram: "@icobarbeariabarbearia",
  ...
  openingTime: "09:00",
  closingTime: "20:00",
  email: "contato@barbeariadoico.com.br",
