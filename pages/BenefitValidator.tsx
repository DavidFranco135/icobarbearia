        ...
        {state === 'valid' && previewBenefit && (
          <>
            <div className="space-y-6">
              ...
              {/* Benefício */}
              <div className={`p-5 rounded-2xl border ${isDark ? 'border-[#0D9488]/20 bg-[#0D9488]/5' : 'border-amber-300 bg-amber-50'}`}>
                <div className="flex items-center gap-3">
                  <Gift size={24} className="text-[#0D9488]" />
                  <div>
                    <p className="text-[9px] font-black uppercase tracking-widest text-[#0D9488]">Benefício</p>
