      ...
      {suggestions.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {suggestions.map((sug) => (
            <div 
              key={sug.id} 
              className={`rounded-[2.5rem] p-8 border relative group hover:border-[#0D9488]/40 transition-all duration-500 ${
                theme === 'light' 
            ...
            >
              ...
              <div className="space-y-4">
                <div className="relative">
                  <textarea 
                    ...
                    className={`w-full border rounded-2xl p-4 text-xs outline-none focus:border-[#0D9488] transition-all resize-none h-24 ${
                      theme === 'light'
                  ...
                  <button 
                    ...
                    className="absolute bottom-3 right-3 p-2 bg-[#0D9488] text-black rounded-lg hover:scale-110 transition-all"
                  >
                    <Send size={14} />
                  </button>
                </div>
                {sug.response && (
                  <div className="flex items-center gap-2 px-2">
                    ...
                    <span className="text-[9px] font-black text-[#0D9488] uppercase tracking-widest">
              ...
              <div className={`mt-6 flex items-center justify-between border-t pt-4 ${
                ...
                <div className="w-8 h-8 rounded-lg bg-[#0D9488]/5 flex items-center justify-center text-[#0D9488]/30">
