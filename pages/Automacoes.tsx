...
// ─────────────────────────────────────────────────────────────
// Automações de Marketing — Barbearia do Ico
...
const Automacoes: React.FC = () => {
  ...
  const [cfg3, setCfg3] = useState({ ativo: false, desconto: 10, mensagem: '🎉 Feliz Aniversário, {{nome}}! Você tem {{desconto}}% de desconto essa semana na Barbearia do Ico. Agende agora!' });
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="text-left">
            <div className="flex items-center gap-2">
              ...
              {badge && <span className="text-[9px] font-black px-2 py-0.5 bg-[#0D9488]/20 text-[#0D9488] rounded-lg uppercase">{badge}</span>}
            </div>
    ...
    <div className={`min-h-screen ${bg}`}>
      <div className="max-w-4xl mx-auto p-6 space-y-6 pb-20">
        ...
        >
          ...
          <p className={`text-[10px] font-black uppercase tracking-widest ${isDark ? 'text-teal-400' : 'text-teal-400'}`}>
        ...
        >
          ...
          <div className={`p-4 rounded-2xl border text-sm italic ${isDark ? 'border-white/10 bg-white/3 text-zinc-300' : 'border-zinc-200 bg-zinc-50 text-zinc-600'}`}>
            💬 "🎉 Feliz Aniversário, João! A Barbearia do Ico te dá 10% de desconto no corte essa semana."
          </div>
          <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-3 mt-1">
                    <div className={`h-1.5 rounded-full flex-1 ${isDark ? 'bg-white/10' : 'bg-zinc-200'}`}>
                      <div
                        className="h-full bg-gradient-to-r from-[#0D9488] to-[#e6a85c] rounded-full transition-all"
        ...
        <div className={`rounded-2xl border p-5 flex gap-4 items-start ${isDark ? 'border-[#0D9488]/20 bg-[#0D9488]/5' : 'border-amber-200 bg-amber-50'}`}>
          <Zap size={18} className="text-[#0D9488] mt-0.5 shrink-0" />
          <div>
            <p className={`text-[10px] font-black uppercase tracking-widest text-[#0D9488] mb-1`}>Deploy de Cloud Functions necessário</p>
